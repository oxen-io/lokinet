...
{
  static inline GUID
  MakeGUID(const wchar_t* str)
  {
    GUID guid{};
    if (not IIDFromString(str, &guid))
  ...
  {
    return MakeGUID(L"{a3b42c97-9f04-4672-b87e-cee9c483257f}");
  }

  static inline GUID
  FWPM_LAYER_OUTBOUND_IPPACKET_V4()
  {
    return MakeGUID(L"{e1cd9fe7-f4b5-4273-96c0-592e487b8650}");
  }

  static inline GUID
  FWPM_CONDITION_IP_LOCAL_INTERFACE()
  {
    return MakeGUID(L"{4cd62a49-59c3-4969-b7f3-bda5d32890a4}");
  }

  static inline GUID
  FWPM_CONDITION_IP_REMOTE_ADDRESS()
  {
    return MakeGUID(L"{b235ae9a-1d64-49b8-a44c-5ff3d9095045}");
  }

  static inline GUID
  FWPM_CONDITION_IP_LOCAL_PORT()
  {
    return MakeGUID(L"{0c1ba1af-5765-453f-af22-a8f791ac775b}");
  }

  static inline GUID
  FWPM_CONDITION_IP_REMOTE_PORT()
  {
    return MakeGUID(L"{c35a604d-d22b-4e1a-91b4-68f674ee674b}");
  }

  static inline GUID
  FWPM_LAYER_ALE_AUTH_CONNECT_V4()
  {
    return MakeGUID(L"{c38d57d1-05a7-4c33-904f-7fbceee60e82}");
  }

  static inline GUID
  FWPM_LAYER_ALE_AUTH_CONNECT_V6()
  {
    return MakeGUID(L"{4a72393b-319f-44bc-84c3-ba54dcb3b6b4}");
  }
  ...
  {
    return MakeGUID(L"{632ce23b-5167-435c-86d7-e903684aa80c}");
  }

  static inline GUID
  FWPM_CONDITION_IP_PROTOCOL()
  {
    return MakeGUID(L"{3971ef2b-623e-4f9a-8cb1-6e79b806b9a7}");
  }
