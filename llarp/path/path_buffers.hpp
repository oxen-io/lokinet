...
#include <messages/relay.hpp>
 ...
 { 
    ...
    struct Batch
    {
      ...
      using DownstreamBufferPool_t = util::BufferPool<DownstreamTraffic_t, false>;
      ...
      struct MemPool
      {
        ...
        void 
        ReturnUpstreamBufferPool(UpstreamBufferPool_t::Ptr_t);

        DownstreamBufferPool_t::Ptr_t
        ObtainDownstreamBufferPool();

        void 
        ReturnDownstreamBufferPool(DownstreamBufferPool_t::Ptr_t);
        private: 
        MemPool_Impl * m_Impl;
      };
